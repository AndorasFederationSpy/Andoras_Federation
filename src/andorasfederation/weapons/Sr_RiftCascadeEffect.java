 ...
 */
public class Sr_RiftCascadeEffect implements BeamEffectPlugin { //WithReset {
	
	public static Color STANDARD_RIFT_COLOR = new Color(60,255,70,255);
	public static Color EXPLOSION_UNDERCOLOR = new Color(0,100,0,100);
	public static Color NEGATIVE_SOURCE_COLOR = new Color(255,200,255,30);
	
	public static String RIFTCASCADE_MINELAYER = "sr_riftcascade_minelayer";
	
	public static int MAX_RIFTS = 13;
	public static float UNUSED_RANGE_PER_SPAWN = 200;
	public static float SPAWN_SPACING = 105;
...
//		if (!canSpawn || beam.getBrightness() >= 1f) return;
	...
	public void spawnNegativeParticles(CombatEngineAPI engine, BeamAPI beam) {
		...
		NEGATIVE_SOURCE_COLOR = new Color(15,255,0,30);
...
//		Vector2f perp2 = new Vector2f(dir.y, -dir.x);
		...
		//Color color = new Color(60,255,70,255);
		...
		if (length > spawnOtherParticleRange * 2f && (float) Math.random() < 0.25f) {
			//color = new Color(60,255,70,255);		
			color = new Color(60,255,70,75);		
