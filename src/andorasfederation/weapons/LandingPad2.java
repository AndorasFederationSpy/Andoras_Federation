         ...
         while(true) {
            ...
            if (isDetaching && !isReturning && !this.isDocking && !isRearming || !parent.isAlive()) {
               if (isInDockingProcedure) {
                  ...
                  //Global.getSoundPlayer().playSound("drone_launch", 1.0F, 1.0F, leader.getLocation(), new Vector2f(0.0F, 0.0F));
               }
               ...
               if (isRearming) {
                  ...
                  if (rearmTimer.intervalElapsed()) {
                     ...
                     //if (playSound) {
                     //   Global.getSoundPlayer().playSound("missile_weapon_reloaded", 1.0F, 1.0F, leader.getLocation(), leader.getVelocity());
                     //}
                  }
