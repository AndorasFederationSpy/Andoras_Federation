 ...
 */
public class Sr_RiftTorpedoEffect implements OnFireEffectPlugin, OnHitEffectPlugin {

	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		Color color = Sr_RiftCascadeEffect.STANDARD_RIFT_COLOR;
		...
		Global.getSoundPlayer().playSound("sr_terriblefate_explosion", 1f, 1f, point, vel);
	}
	
	public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
		Sr_RiftTrailEffect trail = new Sr_RiftTrailEffect((MissileAPI) projectile, "rifttorpedo_loop");
